...
echo "<div style='width:500px; margin-left: 100px;'>
	...
	<h3>Editar Livro $nomeLivro</h3><hr>
	<div>
		<form method='post' action='editLivro.php?idLivro=$idLivro'>
		<div>
			<label>nome do Livro</label>
			<input type='text' name='nomeLivro' value='$nomeLivro' class='form-control'>
		</div>		
    <div>
      <label>Gênero do Livro</label>
      <input type='text' name='generoLivro' value='$generoLivro' class='form-control'>
    </div>
    <div>
      <label>Volume do Livro</label>
      <input type='text' name='volumeLivro' value='$volumeLivro' class='form-control'>
    </div><br/>
		<div>

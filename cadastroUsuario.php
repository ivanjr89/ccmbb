...
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/css/select2.min.css" rel="stylesheet" />
    ...
    <body>
            <h3 style="text-align:center; margin-top: 50px;">Sistema Escola Beatriz Biavatti - Colégio Cívico Militar</h3>
    <div style="text-align: center; margin-top: 100px; width: 300px; margin-left: 550px;">
        
        <form action="salvaUsuario.php" class="form-group" method="post">
